...
TRP3_CompanionPetData = C_PetJournal and {}
	or {
...
TRP3_CompanionMountData = C_MountJournal and {}
	or {
...
do
	...
	TRP3_API.Ellyb.GameEvents.registerCallback("UNIT_AURA", function(unit)
		...
		rescanSummonedMountID = rescanSummonedMountID
			or (unit == "player") and (previousMountedStatus ~= currentMountedStatus)
