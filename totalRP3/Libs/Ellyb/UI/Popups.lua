...
function Popups:OpenURL(url, customText, customShortcutInstructions, customAlertOnClose)
	...
	popupText = popupText .. customShortcutInstructions:format(ORANGE_FONT_COLOR:WrapTextInColorCode(Ellyb.System.SHORTCUTS.COPY), ORANGE_FONT_COLOR:WrapTextInColorCode(Ellyb.System.SHORTCUTS.PASTE));
