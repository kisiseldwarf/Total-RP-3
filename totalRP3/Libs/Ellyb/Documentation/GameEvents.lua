	...
	Functions = {
		{
			...
			Arguments = {
				{ Name = "event", Type = "string", Nilable = false, Documentation = { "A game event to listen to." } },
				{
					...
					Type = "function",
					Nilable = false,
					Documentation = { "A callback that will be called when the event is fired with its arguments." },
				},
			},
			...
			Returns = {
				{
					...
					Type = "string",
					Nilable = false,
					Documentation = { "A handler ID that can be used to unregister the callback later." },
				},
			},
		},
		{
			...
			Arguments = {
				{
					...
					Type = "string",
					Nilable = false,
					Documentation = { "The handler ID of a previsouly registered callback that we want to unregister." },
				},
			},
		},
			...
			Arguments = {
				{
					...
					Type = "string",
					Nilable = false,
					Documentation = { "A game event to manually trigger." },
				},
				{
					Name = "...",
					Type = "any",
					Nilable = false,
					Documentation = { "Arguments to pass to the listeners" },
				},
			},
		},
	},
