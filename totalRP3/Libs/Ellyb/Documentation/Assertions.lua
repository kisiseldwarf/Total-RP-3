			...
			Arguments = {
				{
					Name = "variable",
					Type = "any",
					Documentation = { "Any kind of variable, to be tested for its type" },
				},
				{ Name = "expectedType", Type = "string", Documentation = { "Expected type of the variable" } },
				{
					Name = "variableName",
					Type = "string",
					Documentation = { "The name of the variable being tested, will be visible in the error message" },
				},
			},
		},
		{
...
Can also check for Widget types ("Frame", "Button", "Texture")]],
			...
			Arguments = {
				...
				},
				{
					Name = "expectedTypes",
					Type = "table",
					Documentation = { "A list of expected types for the variable" },
				},
				{
					Name = "variableName",
					Type = "string",
			...
			Arguments = {
				{
					Name = "variable",
					Type = "any",
					Documentation = { "Any kind of variable, to be tested for its content" },
				},
				{
					Name = "possibleValues",
					Type = "table",
					Documentation = { "A table of the possible values accepted" },
				},
				{
					Name = "variableName",
					Type = "string",
