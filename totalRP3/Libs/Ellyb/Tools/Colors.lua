...
function Color:__eq(colorB)
	...
	return redA == redB and greenA == greenB and blueA == blueB and alphaA == alphaB
end
...
function Color:IsEqualTo(colorB)
	Ellyb.DeprecationWarnings.warn(
		"Color:IsEqualTo(otherColor) is deprecated. You should do a simple comparison colorA == colorB"
	)
	return self == colorB
end
