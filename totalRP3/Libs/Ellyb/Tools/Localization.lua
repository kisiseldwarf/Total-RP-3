...
function Localization:GetText(localizationKey)
	return self:GetActiveLocale():GetText(localizationKey) -- Look in the currently active locale
		or (self:GetLocale(DEFAULT_LOCALE_CODE) and self:GetLocale(DEFAULT_LOCALE_CODE):GetText(localizationKey)) -- Look in the English locale from Curse
		or self:GetDefaultLocale():GetText(localizationKey) -- Look in the default locale
		or localizationKey -- As a last resort, to avoid nil strings, return the key itself
end
