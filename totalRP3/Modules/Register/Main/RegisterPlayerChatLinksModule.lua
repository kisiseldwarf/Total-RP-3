...
TRP3_API.events.listenToEvent(TRP3_API.events.WORKFLOW_ON_LOADED, function()
	local RegisterPlayerChatLinksModule =
		TRP3_API.ChatLinks:InstantiateModule(loc.CL_DIRECTORY_PLAYER_PROFILE, "DIR_PLAYER_PROFILE")
	...
	function RegisterPlayerChatLinksModule:GetTooltipLines(tooltipData)
		...
		tooltipLines:SetTitle(
			customColor(
				Utils.str.icon(profile.characteristics.IC or TRP3_InterfaceIcons.ProfileDefault, 20)
					.. " "
					.. TRP3_API.register.getCompleteName(profile.characteristics, profile.profileName, true)
			)
		)
	...
	local OpenProfileButton =
		RegisterPlayerChatLinksModule:NewActionButton("OPEN_REG_PROFILE", loc.CL_OPEN_PROFILE, "REG_P_O_Q", "REG_P_O_A")
	...
	local ImportRegisterPlayerProfileButton = RegisterPlayerChatLinksModule:NewActionButton(
		"IMPORT_REG_PROFILE",
		loc.CL_IMPORT_PROFILE,
		"REG_P_I_Q",
		"REG_P_I_A"
	)
