...
local assert, tostring, type, _G, wipe, strtrim, strconcat, pairs =
	assert, tostring, type, _G, wipe, strtrim, strconcat, pairs
...
local isUnitIDKnown, hasProfile, getUnitProfile =
	TRP3_API.register.isUnitIDKnown, TRP3_API.register.hasProfile, TRP3_API.register.getProfile
...
local function onPlayerIconSelected(icon)
	draftData.IC = icon
	setupIconButton(
		TRP3_CompanionsPageInformationEdit_NamePanel_Icon,
		draftData.IC or TRP3_InterfaceIcons.ProfileDefault
	)
end
...
function displayConsult(context)
	...
	TRP3_CompanionsPageInformationConsult_NamePanel_Name:SetText(
		"|cff" .. (dataTab.NH or "ffffff") .. (dataTab.NA or UNKNOWN)
	)
	TRP3_CompanionsPageInformationConsult_NamePanel_Title:SetText(dataTab.TI or "")
	setupIconButton(
		TRP3_CompanionsPageInformationConsult_NamePanel_Icon,
		dataTab.IC or TRP3_InterfaceIcons.ProfileDefault
	)
...
TRP3_API.events.listenToEvent(TRP3_API.events.WORKFLOW_ON_LOAD, function()
	...
	TRP3_CompanionsPageInformationEdit_NamePanel_Icon:SetScript("OnClick", function()
	...
	setupListBox(TRP3_CompanionsPageInformationEdit_About_BckField, bkgTab, function(value)
		setBkg(TRP3_CompanionsPageInformationEdit_About, value)
	end, nil, 120, true)
	TRP3_API.ui.text.setupToolbar(
		TRP3_CompanionsPageInformationEdit_About_Toolbar,
		TRP3_CompanionsPageInformationEdit_About_TextScrollText
	)

	setTooltipForSameFrame(
		TRP3_CompanionsPageInformationConsult_GlanceHelp,
		"LEFT",
		0,
		10,
		loc.REG_PLAYER_GLANCE,
		loc.REG_PLAYER_GLANCE_CONFIG
	)
	...
	TRP3_API.events.listenToEvent(TRP3_API.events.NAVIGATION_RESIZED, function(containerWidth)
		...
		TRP3_CompanionsPageInformationConsult_About_ScrollText:SetText(
			TRP3_CompanionsPageInformationConsult_About_ScrollText.html or ""
		)
