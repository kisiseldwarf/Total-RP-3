...
TRP3_API.events.listenToEvent(TRP3_API.events.WORKFLOW_ON_LOADED, function()
	local CompanionProfileChatLinksModule =
		TRP3_API.ChatLinks:InstantiateModule(loc.CL_COMPANION_PROFILE, "COMPANION_PROFILE")
	...
	local OpenCompanionProfileButton =
		CompanionProfileChatLinksModule:NewActionButton("OPEN_COMPANION", loc.CL_OPEN_COMPANION, "CMPN_O_Q", "CMPN_O_A")
	...
	local ImportCompanionProfileButton = CompanionProfileChatLinksModule:NewActionButton(
		"IMPORT_COMPANION",
