...
module.REQUEST_FIELDS =
	{ "TT", "AE", "AG", "AH", "AW", "CO", "DE", "HB", "HH", "HI", "IC", "MO", "NH", "MU", "PE", "PS", "RS", "PN" }
...
module.TryRegisterField("PS", {
	Serialize = function(traits)
		...
		for i = 1, #traits do
			...
			if trait.ID and trait.ID >= PS_MIN_BUILTIN_TRAIT_ID and trait.ID <= PS_MAX_BUILTIN_TRAIT_ID then
