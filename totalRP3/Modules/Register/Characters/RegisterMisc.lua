...
local function displayRPStyle(context)
	...
	for index, fieldData in pairs(STYLE_FIELDS) do
		...
		if frame == nil then
			frame = CreateFrame(
				"Frame",
				"TRP3_RegisterMiscViewRPStyle_line" .. index,
				TRP3_RegisterMiscViewRPStyle,
				"TRP3_RegisterRPStyleMain_Edit_Line"
			)
...
local TRP3_RegisterMiscViewCurrentlyIC, TRP3_RegisterMiscViewCurrentlyOOC =
	TRP3_RegisterMiscViewCurrentlyICScrollText, TRP3_RegisterMiscViewCurrentlyOOCScrollText
		...
		},
		{
			...
			button = {
				...
				text = loc.DB_STATUS_CURRENTLY_COMMON
					.. "\n\n"
					.. "|cff00ff00"
					.. loc.DB_STATUS_CURRENTLY
					.. ":|r\n"
					.. loc.DB_STATUS_CURRENTLY_TT
					.. "\n\n|cff00ff00"
					.. loc.DB_STATUS_CURRENTLY_OOC
					.. ":|r\n"
...
function TRP3_API.register.inits.miscInit()
	...
	setTooltipForSameFrame(
		TRP3_RegisterMiscViewCurrentlyICHelp,
		"LEFT",
		0,
		10,
		loc.DB_STATUS_CURRENTLY,
	...
	setTooltipForSameFrame(
		TRP3_RegisterMiscViewCurrentlyOOCHelp,
		"LEFT",
		0,
		10,
		loc.DB_STATUS_CURRENTLY_OOC,
	...
	setTooltipForSameFrame(
		TRP3_RegisterMiscViewGlanceHelp,
		"LEFT",
		0,
		10,
	...
	Events.listenToEvent(Events.REGISTER_DATA_UPDATED, function(unitID, _, dataType)
		if
			getCurrentPageID() == "player_main"
			and unitID == Globals.player_id
			and (not dataType or dataType == "misc")
		then
