...
function TRP3_BlizzardNamePlates:OnModuleEnable()
	...
	hooksecurefunc("CompactUnitFrame_SetUpFrame", function(...)
		return self:OnUnitFrameSetUp(...)
	end)
	hooksecurefunc(NamePlateDriverFrame, "UpdateNamePlateOptions", function()
		return self:OnUpdateNamePlateOptions()
	end)
...
TRP3_API.module.registerModule({
	...
	onInit = function()
		return TRP3_BlizzardNamePlates:OnModuleInitialize()
	end,
	onStart = function()
		return TRP3_BlizzardNamePlates:OnModuleEnable()
	end,
})
