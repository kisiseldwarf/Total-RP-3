...
function TRP3_NamePlates:OnModuleInitialize()
	...
	self.callbacks.OnUsed = function()
		self:OnModuleUsed()
	end
...
function TRP3_NamePlates:ActivateModule()
	...
	TRP3_API.Ellyb.GameEvents.registerCallback("NAME_PLATE_UNIT_ADDED", function(...)
		return self:OnNamePlateUnitAdded(...)
	end)
	TRP3_API.Ellyb.GameEvents.registerCallback("NAME_PLATE_UNIT_REMOVED", function(...)
		return self:OnNamePlateUnitRemoved(...)
	end)
	TRP3_API.Ellyb.GameEvents.registerCallback("UNIT_NAME_UPDATE", function(...)
		return self:OnUnitNameUpdate(...)
	end)
	TRP3_API.Ellyb.GameEvents.registerCallback("PLAYER_REGEN_DISABLED", function(...)
		return self:OnPlayerRegenDisabled(...)
	end)
	TRP3_API.Ellyb.GameEvents.registerCallback("PLAYER_REGEN_ENABLED", function(...)
		return self:OnPlayerRegenEnabled(...)
	end)

	TRP3_API.Events.registerCallback("CONFIGURATION_CHANGED", function(...)
		return self:OnConfigurationChanged(...)
	end)
	TRP3_API.Events.registerCallback("REGISTER_DATA_UPDATED", function(...)
		return self:OnRegisterDataUpdated(...)
	end)
...
TRP3_API.module.registerModule({
	...
	minVersion = 92,
	onInit = function()
		return TRP3_NamePlates:OnModuleInitialize()
	end,
	onStart = function()
		return TRP3_NamePlates:OnModuleEnable()
	end,
})
