...
function TRP3_KuiNamePlates:OnModuleEnable()
	...
	self.plugin.Create = function(_, ...)
		return self:OnNamePlateCreate(...)
	end
	self.plugin.Show = function(_, ...)
		return self:OnNamePlateShow(...)
	end
	self.plugin.HealthUpdate = function(_, ...)
		return self:OnNamePlateHealthUpdate(...)
	end
	self.plugin.HealthColourChange = function(_, ...)
		return self:OnNamePlateHealthColourChange(...)
	end
	self.plugin.GlowColourChange = function(_, ...)
		return self:OnNamePlateGlowColourChange(...)
	end
	self.plugin.GainedTarget = function(_, ...)
		return self:OnNamePlateGainedTarget(...)
	end
	self.plugin.LostTarget = function(_, ...)
		return self:OnNamePlateLostTarget(...)
	end
	self.plugin.Combat = function(_, ...)
		return self:OnNamePlateCombat(...)
	end
	self.plugin.Hide = function(_, ...)
		return self:OnNamePlateHide(...)
	end
...
function TRP3_KuiNamePlates:OnNamePlateCreate(nameplate)
	...
	hooksecurefunc(nameplate, "UpdateNameText", function(...)
		return self:OnNameplateNameTextUpdated(...)
	end)
...
TRP3_API.module.registerModule({
	...
	onInit = function()
		return TRP3_KuiNamePlates:OnModuleInitialize()
	end,
	onStart = function()
		return TRP3_KuiNamePlates:OnModuleEnable()
	end,
})
