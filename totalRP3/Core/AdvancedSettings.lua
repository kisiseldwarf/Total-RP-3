...
TRP3_API.events.listenToEvent(TRP3_API.events.WORKFLOW_ON_LOAD, function()
	...
	if TRP3_ClientFeatures.BroadcastMethod == TRP3_BroadcastMethod.Channel then
		...
		TRP3_API.ADVANCED_SETTINGS_DEFAULT_VALUES[TRP3_API.ADVANCED_SETTINGS_KEYS.BROADCAST_CHANNEL] =
			"xtensionxtooltip2"
		tinsert(TRP3_API.ADVANCED_SETTINGS_STRUCTURE.elements, {
		...
		TRP3_API.ADVANCED_SETTINGS_DEFAULT_VALUES[TRP3_API.ADVANCED_SETTINGS_KEYS.MAKE_SURE_BROADCAST_CHANNEL_IS_LAST] =
			true
		tinsert(TRP3_API.ADVANCED_SETTINGS_STRUCTURE.elements, {
			inherit = "TRP3_ConfigCheck",
	...
	tinsert(TRP3_API.ADVANCED_SETTINGS_STRUCTURE.elements, {
		...
		listCallback = function(newLocaleCode)
			...
			TRP3_API.popup.showConfirmPopup(
				loc.CO_GENERAL_CHANGELOCALE_ALERT:format(
					Ellyb.ColorManager.GREEN(loc:GetLocale(newLocaleCode):GetName())
				),
				ReloadUI
			)
		end,
