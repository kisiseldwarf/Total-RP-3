...
local function buildConfigurationPage(structure)
	...
	for _, element in pairs(structure.elements) do
		local widget = element.widget
			or CreateFrame(
				"Frame",
				element.widgetName or ("TRP3_ConfigurationWidget" .. GENERATED_WIDGET_INDEX),
				structure.parent,
				element.inherit
			)
...
local function registerConfigurationPage(pageStructure)
	...
	pageStructure.frame = CreateFrame(
		"Frame",
		"TRP3_ConfigurationPage" .. configurationPageCount,
		TRP3_MainFramePageContainer,
		"TRP3_ConfigurationPage"
	)
...
TRP3_API.events.listenToEvent(TRP3_API.events.WORKFLOW_ON_LOAD, function()
	...
	registerMenu({
		...
		onSelected = function()
			selectMenu("main_91_config_main_config_aaa_general")
		end,
	})
