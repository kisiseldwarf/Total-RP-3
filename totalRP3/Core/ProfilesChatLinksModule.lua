...
TRP3_API.events.listenToEvent(TRP3_API.events.WORKFLOW_ON_LOADED, function()
	...
	function ProfilesChatLinkModule:GetTooltipLines(tooltipData)
		...
		tooltipLines:SetTitle(
			customColor(
				Utils.str.icon(info.characteristics.IC or TRP3_InterfaceIcons.ProfileDefault, 20)
					.. " "
					.. TRP3_API.register.getCompleteName(info.characteristics, profile.profileName, true)
			)
		)
	...
	local ImportProfileButton =
		ProfilesChatLinkModule:NewActionButton("IMPORT_PLAYER_PROFILE", loc.CL_IMPORT_PROFILE, "PROF_I_Q", "PROF_I_A")
	...
	local OpenProfileButton =
		ProfilesChatLinkModule:NewActionButton("OPEN_PLAYER_PROFILE", loc.CL_OPEN_PROFILE, "PROF_O_Q", "PROF_O_A")
