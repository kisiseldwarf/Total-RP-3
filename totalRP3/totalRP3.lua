...
function TRP3_ShowErrorMessage()
	...
	print(TRP3_API.Colors.ITEM_ARTIFACT("Note: If you just recently updated the add-on, remember that you need to fully relaunch the game client. Updating while the game client is open will not load new files."));
end
